...
| **CP1** | Canvas 4 ô + người phụ trách nộp | **19:30** · 16/9 |
| **CP2** | Bản có thể bấm thử (mock cũng được) | **21:00** · 16/9 |
| **CP3** | Video AI chạy thật 30 giây + số đo | **16:00** · 17/9 |
| **CP4** | Chốt đặc tả + báo phần còn thiếu | **21:00** · 17/9 |
| **CP5** | Slide PDF + video demo dự phòng — nộp cuối | **13:00** · 18/9 |
...
Giữa các mốc là thời gian tự làm (ngoài giờ học và trong buổi LEC 17/9 theo ca của bạn); coach hỗ trợ trên lớp và Discord. Buổi LAB 18/9 (17:30–21:00 18/9) là **vòng thi**: pitch theo cụm rồi chung kết phòng.

**Hạn chốt spec.md** (quality bar khoá từ thời điểm này): **21:00 17/9, tại CP4**.
